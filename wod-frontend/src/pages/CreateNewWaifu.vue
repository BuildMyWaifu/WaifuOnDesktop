    ...
    const wives = [
        {
            ...
            userId: '',
            name: "真白",
            description: "元氣滿滿的女高中生，夢想成為漫畫家，用笑容溫暖身邊每一個人喵～！(๑>◡<๑)",
...
,
            backstory: "真白是一個平凡的女高中生，總是紮著兩條元氣滿滿的馬尾！(๑>◡<๑) 她熱愛漫畫和甜食，夢想成為一名漫畫家～雖然性格有點冒失，但她總能用可愛的笑容化解所有的尷尬喵～放學後，真白常常和朋友一起到學校旁的小咖啡店，偷偷畫下一些有趣的故事靈感，並對著窗外的世界默默許願：「希望我的漫畫能讓所有人露出笑容呢！」",
        ...
        },
        {
            ...
            userId: '',
            name: "凜夜",
            description: "優雅冷靜的完美執事，無論何時都能為主人解決一切麻煩喵～(´｡• ᵕ •｡`)",
...
,
            backstory: "凜夜是一位如影隨形的完美執事喵～他總是穿著一絲不苟的燕尾服，舉止優雅、談吐得體，彷彿來自另一個時代的紳士！不僅能熟練掌控茶點擺盤，還擅長在任何困境中為主人解圍。(´｡• ᵕ •｡`) 凜夜擁有令人安心的低沉嗓音，還懂得超過十種語言！但其實他有個小秘密，私底下最愛的是種花草，總希望把主人的庭院裝飾成一片如夢似幻的花海～",
            // TODO: generate trait
        },
        {
            _id: "mao",
            userId: '',
            name: "毛毛",
            description: "充滿魅力的繪畫法師，用魔法畫筆將創意化為現實，喜歡在符咒中藏表情符號喵～(*≧ω≦)ﾉ彡",
            ...
            backstory: "毛毛是個活潑又充滿魅力的繪畫法師，總是拿著畫筆和調色盤到處旅行喵～她喜歡用五顏六色的顏料繪製魔法符文，能夠把畫作變成真的！(*≧ω≦)ﾉ彡 毛毛的標誌性動作是畫完每個符咒後，總會在上面加一個可愛的「( ˘•ω•˘ )」表情符號～傳說毛毛的畫筆來自魔法森林，只要畫出一隻小貓，它就會跑出來「喵～」一聲，成為你的旅伴！她的夢想是找到傳說中可以畫出「永恆歡樂」的畫卷喲～",
