<template>
  ...
  <div class="d-flex align-center" v-if="localCompanion" style="max-width: 100%;max-height: 100vh;">
    <div class="d-flex justify-center h-100 w-50 align-center overflow-hidden align-center justify-center ml-4">
    ...
    <div class="text-start w-50 overflow-y-auto" style="max-height: 100%;">
      ...
      <v-btn v-if="!readonly" :to="`/liveChat/${companionId}`" variant="outlined" class="ma-4"
